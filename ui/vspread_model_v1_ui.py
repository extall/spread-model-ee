...
class Ui_SpreadEEGui(object):
    def setupUi(self, SpreadEEGui):
        ...
        self.lineEdit = QtWidgets.QLineEdit(self.gbModelInitialization)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.lineEdit_3 = QtWidgets.QLineEdit(self.gbSimulation)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
    ...
    def retranslateUi(self, SpreadEEGui):
        ...
        self.gbModelInitialization.setTitle(_translate("SpreadEEGui", "Step 1: Model initialization : Parameters cannot be changed unless a new simulation is created"))
        ...
        self.lineEdit.setText(_translate("SpreadEEGui", "0.1"))
        self.gbSimulation.setTitle(_translate("SpreadEEGui", "Step 2: Run simulation : Change the below parameters to analyze different outcomes"))
        self.label_18.setText(_translate("SpreadEEGui", "Prob (mobility between regions is unrestricted) ="))
        ...
        self.label_19.setText(_translate("SpreadEEGui", "Prob (mobility between Saaremaa and mainland is unrestricted) ="))
        ...
        self.lineEdit_3.setText(_translate("SpreadEEGui", "90"))
        ...
        self.gbConfigurationFile.setTitle(_translate("SpreadEEGui", "Simulation configuration file"))
